...
<html lang="es">
    <head>
        <title>Panel ~ Editar Nóminas</title>
    ...
    <script type="text/javascript">
		function sugerencias(p,e){
		 ...
		 xmlhttp.open("GET","actions/nominaB.php?p="+p+"&e="+e,true);
                 xmlhttp.send();
		}
	</script>
    </head>
        ...
        <div class="rows">
            <div class="container">
                   <div class="col-lg-12 light">
                       <p class="text-center h1" style="color: #000;">Gestión de nóminas</p>
                           ...
                           <div class="form col-lg-4">
                               <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input id="periodoNom" value="<?php echo $periodo; ?>" onLoad="sugerencias(this.value, document.getElementById('BuscEmp').value)" onInput="sugerencias(this.value, document.getElementById('BuscEmp').value)" type="number" class="form-control" style="height: 35px;" >
                                </div>
                                </div>
                                </div>
                                </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <input id="BuscEmp" class="form-control" style="height: 35px;" onkeyup="sugerencias(document.getElementById('periodoNom').value, this.value)">
                           </div>
                           </div>
                           </div>
                           </div>
