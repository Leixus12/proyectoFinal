                       ...
                       <div class="col-lg-9 col-lg-offset-2">
                           <div class="col-lg-4">
                               ...
                               <div class="form-group" style="display: none;">
                                   ...
                                   <input type="text" maxlength="20" id="idPuesto" name="idPuesto" value="<?php echo $puesto->getIdPuesto();?>" class="form-control">
                               </div>
                               <div class="form-group">
                                   <label class="h4">Puesto:</label>
                                   <input type="text" maxlength="20" id="nomPuesto" name="nomPuesto" value="<?php echo $puesto->getNombrePuest();?>" class="form-control">
                               </div>
                               <div class="form-group">
                                   <label class="h4">Descripción:</label>
                                   <textarea maxlength="150" class="form-control"  name="descPuest" ><?php echo $puesto->getDescripcion();?></textarea>
                               </div>
                               <div class="form-group">
                                   <label class="h4">Salario diario:</label>
                                   <input type="text" id="salPuesto" name="salPuesto" value="<?php echo $puesto->getSalarioDia();?>" class="form-control">
                               </div>
                                   <button type="submit" name="modPuesto" class="btn btn-primary btn-lg">GUARDAR</button>
