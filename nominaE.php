...
<html lang="es">
    ...
    <script type="text/javascript">
		function sugerencias(str){
		 ...
		 xmlhttp.open("GET","actions/nominaE.php?q="+str,true);
                 xmlhttp.send();
		}
	</script>
    </head>
    <body >
		...
		<?php 
                        ...
                        $pdo = new conexion();
			$sql_registe = $pdo->prepare("SELECT COUNT(*) as total_registro FROM nomina where idEmpleado = $idEmpleado;");
                        $sql_registe->execute();
