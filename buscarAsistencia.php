...
<html lang="es">
    ...
    <script type="text/javascript">
		function sugerencias(str,f){
		 ...
		 xmlhttp.open("GET","actions/asistenciaB.php?q="+str+"&f="+f,true);
                 xmlhttp.send();
		}
	</script>
    </head>
    <body >
        ...
        <div class="rows">
            <div class="container">
                   <div class="col-lg-12 light">
                       <p class="text-center h1" style="color: #000;">Gestión de asistencia</p>
                           ...
                           <div class="form col-lg-4">
                             ...
                             <div class="form-group">
                                 ...
                                 <input class="form-control" id="empAs" style="height: 45px;" onkeyup="sugerencias(this.value, document.getElementById('fechaAs').value)">
                           </div>
                           </div>
                           </div>
                           </div>
                           ...
                           <div class="form col-lg-4">
                               <div class="form-group">
                                        <label class="h4">Fecha:</label>
                                        <input class="form-control" id="fechaAs" type="date" style="height: 45px;" onInput="sugerencias(document.getElementById('empAs').value, this.value)"><br>
                                </div>
                           </div>
		...
		<?php 
			...
			$sql_registe = $pdo->prepare("SELECT COUNT(*) "
                                       . "as total_registro FROM asistencia;");
                        $sql_registe->execute();
